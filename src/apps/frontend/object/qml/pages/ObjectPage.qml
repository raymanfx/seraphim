    ...
    GridLayout {
        ...
        ColumnLayout {
            ...
            Button {
                ...
                onClicked: {
                    active = !active;
                    mainWindow.objectRecognitionButtonClicked();
                }

                contentItem: Text {
                    text: objectClassificationButton.text
                    font: objectClassificationButton.font
                    opacity: enabled ? 1.0 : 0.3
                    color: objectClassificationButton.pressed ? "#F84018" : "#FFFFFF";
                ...
                background: Rectangle {
                    color: objectClassificationButton.active ? "#F84018" : "#000000";
                    border.color: "#FFFFFF";
                    border.width: 1
                    radius: 2
