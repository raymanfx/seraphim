...
static char const *long_opts_desc[] = { "Camera index", "Confidende threshold",
                                        "Model config path (*.prototxt.txt)",
                                        "Model path (*.caffemodel)", "Show help" };
